...
\usepackage[letterpaper, top=2cm, bottom=2cm, inner=2cm,
outer=2cm, foot=.25in]{geometry}
...
There are $n_U$ users and $n_M$ movies.  The \term{ratings matrix}
...
not amenable to datasets of such scale; hence, we \TODO{describe how
  we got this small fully packed rating matrix}. Our packed matrix
